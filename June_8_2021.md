...
In this class you will be asked to try out simple programming exercises and given example codes that may be useful for your future project research. Programming is in many respects like cooking- following directions is important when learning, but there are always ways to do things differently and still get the job done.


## At the end of the course you will be able to:
1. Become familiar superficially with the Linux computing environment.
1. Perform basic scientific calculations relevant to environmental fields using Python. 
1. Be aware of best practices to write, and execute computer programs. 
...
1. Employ techniques to access, process, and visualize environmental data sets.
